...
public class Vector2dTest {
    ...
    void neighbours(){
        ...
        assertTrue(neighbours.contains(new Vector2d(2,3)));
        assertTrue(neighbours.contains(new Vector2d(1,3)));
        assertTrue(neighbours.contains(new Vector2d(2,2)));
        assertTrue(neighbours.contains(new Vector2d(0,1)));
        assertTrue(neighbours.contains(new Vector2d(0,2)));
        assertTrue(neighbours.contains(new Vector2d(1,1)));
        assertTrue(neighbours.contains(new Vector2d(0,3)));
        assertTrue(neighbours.contains(new Vector2d(2,1)));
    }
}
